...
ownership:
  responsibility: "Immutable replay identities, request fingerprints, captured results, state transitions and durable ledger ports."
...
framework_php:
  ...
  extracted_symbols:
    ...
    - old_fqcn: "Kumwe\\App\\Application\\Idempotency\\IdempotencyLedger"
      ...
      exceptions: []
      serialization_contract: "Documented PHP scalar/array projections; no native PHP serialized object is a durable wire contract."
      compatibility: "The host implements this unchanged contract; sequential reference-adapter conformance does not establish database atomicity or authorization."
    ...
    - old_fqcn: "Kumwe\\App\\Application\\Automation\\IdempotencyState"
      ...
      public_constants:
        ...
        - "IN_PROGRESS"
      exceptions: []
      serialization_contract: "Stable backing strings: in_progress, completed, failed. Native PHP serialized objects are not a durable wire contract."
      compatibility: "Unchanged string-backed state enum; cases, from, tryFrom, name and value are included in the public contract."
...
consumer_contract:
  ...
  dependency_or_native_change: "Retain exact canonical-json 0.1.1; verify its external attestation and the selected Idempotency release before consumer adoption"
  namespace_or_api_replacements:
    ...
    - "Kumwe\\App\\Application\\Idempotency\\SecretOnceIdempotencyLedger -> Kumwe\\Idempotency\\SecretOnceIdempotencyLedger"
  files_to_update:
    - "composer.json"
    - "composer.lock"
    - "src/Application/Automation/Job/PurgeIdempotencyRecordsHandler.php"
...
decisions:
  ...
  - "No final-head or archive digest is embedded self-referentially; independent verification records actual release evidence."
blockers: []
---
